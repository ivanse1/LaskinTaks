...
public class LaskinTest { // Luokan nimen loppu pitää olla Test
    ...
    @Test
    @DisplayName("Testaa kertolasku 8 * 2")
    public void testKerro() {
       laskin.lisaa(8);
       laskin.kerro(2);
       assertEquals(16, laskin.annaTulos(), "Kertolasku 8*2 väärin");
    }
    
    @Test
    @DisplayName("Liukulukujen jakamisen testaus")
    public void testJaaDouble() {
        laskin.lisaa(8.0);
        laskin.jaa(2.5);
        assertEquals(3.2, laskin.annaTulos(), DELTA, "Jakolasku 8/2.5 väärin");
    }
