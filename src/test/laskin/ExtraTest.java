...
public class ExtraTest extends AbstractParent {
    ...
    public void testNeliojuuriNegat() {
    	IllegalArgumentException poikkeus = assertThrows(IllegalArgumentException.class, () -> laskin.neliojuuri(-4));
        assertEquals("Negatiivisen luvun neliöjuuri ei ole määritelty", poikkeus.getMessage());
    }
}
